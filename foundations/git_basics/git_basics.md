...
Note: Starting October 1st, 2020, all new GitHub repositories now create a default branch named 'main' instead of 'master'. (Read [this article](https://www.theserverside.com/feature/Why-GitHub-renamed-its-master-branch-to-main) by Carolyn Heinze if you wish to understand the reasons behind the change.)
